...
<div className={`sidebar-left ${(props.visible) && 'shown'}`}>
  ...
  <ul className="nav flex-column in" id="side-menu">
    ...
    <li className={location.pathname === "/createcourse" && " nav-item"}>
     ...
     <li className={location.pathname === "/adminDashboard" && " nav-item"}>
      <Link className="menudropdown nav-link" to="/adminDashboard">Admin Dashboard
      <i className="fa fa-road"></i>
      </Link> 
    </li>

     <li className={location.pathname === "/adminGradebook" && " nav-item"}>
      <Link className="menudropdown nav-link" to="/adminGradebook">Admin Gradebook
      <i className="fa fa-road"></i>
      </Link> 
    </li>
