...
export default class EditorCanvas extends React.Component{
	...
	constructor(props){
		...
		if (typeof content === 'undefined' || content === '' || content ===[] || content === null){
			content = [{"cols":[{"params":{"width":"full"},"elements":[{"type":"Headline","params":{"hl":"react-content-builder"}},{"type":"Text","params":{"text":"This is a textblock"}},{"type":"File","params":{"src":"This is a textblock", "listid":"This is a textblock"}}
			]}]}];
		}
