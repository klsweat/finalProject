...
module.exports = {
  // This method handles retrieving Courses from the db
  ...
  // This method handles retrieving Parent Courses from the db assign to user
  parent: function(req, res) {
    ...
    // {is_parent: true, user_id: ""}
    Course.find({is_parent: true})
      .then(function(doc) {
        res.json(doc);
      }).catch(function(err) {
        res.json(err);
